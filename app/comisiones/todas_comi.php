  ...
  <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-12">
                         ...
                         <div class="card">
                            <div class="card-body">
                                <h4 class="card-title">Todas las Comisiones de los Clientes</h4>
                                <h6 class="card-subtitle">Estos son las comisiones de todos los clientes</h6>
                                ...
                                <h3 class="card-title">Total a pagar : USD XXX</h3>
                            </div>
                         </div>
