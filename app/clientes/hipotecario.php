                    ...
                    <div class="col-sm-3 col-xs-12">
                     ...
                     <div class="col-sm-6 col-xs-12">
                        <div class="card card-body">
                            <h4 class="card-title" style="text-align: center;font-size: 22px;font-weight: 600;">Crear cliente Hipotecario</h4><br>
                           ...
                           <?php  
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-12 col-xs-12">
                                    <form action="app/clientes/save_hipo.php" method="post">
                                      
                                        <label for="rol">Datos</label>
                                        <div class="form-group">
                                         <input type="text" class="form-control" name="nombre_apellido" id="usuario" placeholder="Nombre y apellido" required="">
                                        </div>
                                         <div class="form-group">
                                        ...
                                        <select  class="form-control custom-select" data-placeholder="Choose a Category" tabindex="1" name="linea_credito"  required="">
                                               ...
                                               <option value="Credito hipotecario o Leasing Habitacional">Crédito hipotecario o Leasing Habitacional</option>
                                               <option value="Compra de Cartera Hipotecaria">Compra de Cartera Hipotecaria</option>
                                               <option value="Credito para Vivienda de Interés Social">Crédito para Vivienda de Interés Social</option>
                                               <option value="Credito de Remodelacion">Crédito de Remodelación</option>
                                               <option value="Credito para Autoconstrucción">Crédito para Autoconstrucción</option>
                                               <option value="Compra de Lote">Compra de Lote</option>
                                               <option value="Credito para Residentes en el exterior">Crédito para Residentes en el exterior</option>
                                        ...
                                        <div class="form-group">
                                         <input type="text" class="form-control" name="num_cuota"  placeholder="Número de Cuota Actual" required="">
                                        </div>
                                        <div class="form-group">
